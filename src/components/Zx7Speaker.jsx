...
import Image1 from "../resources/assets/product-zx7-speaker/mobile/h3.jpg";
import Image2 from "../resources/assets/product-zx7-speaker/mobile/h4.jpg";
import Image3 from "../resources/assets/product-zx7-speaker/mobile/h5.jpg";
import Image4 from "../resources/assets/product-zx7-speaker/mobile/h1.jpg";
...
import Image8 from "../resources/assets/product-zx7-speaker/tablet/h2.jpg";
...
import Image12 from "../resources/assets/product-zx7-speaker/desktop/h1.jpg";
        ...
        <div className="mt-40 xl:w-9/12 xl:mx-auto lg:w-9/12 lg:mx-auto">
          <div className="md:flex md:gap-7">
            ...
            <div className="text-left md:w-[650px] md:my-auto">
              ...
              <br />
              <h1 className="text-lg tracking-[1px] font-medium">$ 3,500</h1>
